            ...
            <div className='app'>
                {this.state.showScore ?
                  (<div className='score-section'>
                      You scored {this.state.score} out of {this.state.currentQuestion}
                  </div>):(
                  <>
                  ...
                  <div className='answer-section'>
                      ...
                      answerOptions.map((answer,index)=>(<button key={index} onClick={this.nexQuestion.bind(this,answer.isCorrect)
